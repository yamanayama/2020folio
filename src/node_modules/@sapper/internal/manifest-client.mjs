...
export const ignore = [/^\/blog.json$/, /^\/blog\/([^\/]+?).json$/, /^\/work.json$/, /^\/work\/([^\/]+?).json$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/work/index.svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:work/index.svelte__"
	},
	{
		js: () => import("../../../routes/work/[slug].svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:work/[slug].svelte__"
	}
];
...
if (typeof window !== 'undefined') {
	import("/Users/h-1674/workspace/svelte/2020folio/node_modules/sapper/sapper-dev-client.js").then(client => {
