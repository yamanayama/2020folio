...
* 1920px〜PC（大）
------------*/
const breakpoints = [480, 768, 1280, 1920];
...
<li${add_attribute("class", current, 0)}>${attr[type].segment === "blog"
	? `<a${add_attribute("class", link, 0)} rel="${"prefetch"}"${add_attribute(
			"aria-current",
			segment === attr[type].segment
			? attr[type].caption
			: undefined,
			0
		)}${add_attribute("href", attr[type].link, 0)}>${escape(attr[type].caption)}</a>`
	: `<a${add_attribute("class", link, 0)}${add_attribute(
			"aria-current",
			segment === attr[type].segment
			? attr[type].caption
			: undefined,
...
const AppNav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  `;
	...
	return `<nav${add_attribute("class", nav, 0)}><ul>${validate_component(AppNavItem, "AppNavItem").$$render($$result, { segment, type: "home", value: "" }, {}, {})}
    ...
    ${validate_component(AppNavItem, "AppNavItem").$$render($$result, { segment, type: "contact", value: "" }, {}, {})}</ul></nav>`;
});
...
const AppHead = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  `;
	...
	return `<header>${validate_component(AppHeadLogo, "AppHeadLogo").$$render($$result, {}, {}, {})}
  ${validate_component(AppNav, "AppNav").$$render($$result, { segment }, {}, {})}</header>`;
});
...
<main class="${"svelte-1llcncq"}">${$$slots.default ? $$slots.default({}) : ``}</main>
